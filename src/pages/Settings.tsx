...
/**
 * =================================================================================
 * HOSPITAL DIAGNOSIS CARD SYSTEM - STUDIO MASTER (V25.3.4 - UNIFIED GRID)
 * =================================================================================
 * Features:
 * 1. Single Unified Grid for all fields (1-37).
 * 2. Smart Groups (Purple) vs Standard Fields (Gray).
 * 3. Auto-Layout for Op Note (Field 30) -> Generates 5 boxes.
 * 4. Fixed IDs for Printing.
 */
